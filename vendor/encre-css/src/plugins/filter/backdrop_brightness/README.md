...
<table style="display: table;">
  ...
  <tbody>
    <tr><td>backdrop-brightness-<i>&lt;integer&gt;</i></td><td>backdrop-filter: brightness(<i>&lt;integer / 100&gt;</i>);</td></tr>
  </tbody>
</table>
...
[Tailwind reference](https://tailwindcss.com/docs/backdrop-brightness)
