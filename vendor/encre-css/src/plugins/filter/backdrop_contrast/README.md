...
<table style="display: table;">
  ...
  <tbody>
    <tr><td>backdrop-contrast-<i>&lt;integer&gt;</i></td><td>backdrop-filter: contrast(<i>&lt;integer / 100&gt;</i>);</td></tr>
  </tbody>
</table>
...
[Tailwind reference](https://tailwindcss.com/docs/backdrop-contrast)
